...
export function MultiImageUpload({ onImagesUpload, maxFiles = 10, uploadedFiles = [] }: MultiImageUploadProps) {
    ...
    <div className="relative z-10 fade-in-animation space-y-4">
      ...
      {files.length > 0 && (
        <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-md rounded-2xl p-6 border border-gray-300/50 dark:border-gray-700/50">
          <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Selected Images ({files.length})</h4>
